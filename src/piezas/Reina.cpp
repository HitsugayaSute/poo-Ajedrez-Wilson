...
char Reina::getSimbolo()const{
    return color == Color::BLANCO ? 'Q' : 'q';
}
std::vector<Movimiento> Reina::movimientosLegales(const Tablero& tablero, int fila, int columna)const{
...
std::shared_ptr<Pieza> Reina::clonar()const{
